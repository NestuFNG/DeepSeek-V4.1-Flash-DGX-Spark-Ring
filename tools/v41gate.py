#!/usr/bin/env python3
"""30-generation structured-output garble gate. Usage: v41gate.py <base_v1_url> <model>"""
...
for temp in (0.0, 0.7, 1.0):
    for name, p, mt in P:
        for i in range(4 if temp else 2):
            ...
            r = json.load(urllib.request.urlopen(urllib.request.Request(U, body, {"Content-Type": "application/json"}), timeout=300))
            t = r["choices"][0]["message"].get("content") or ""; n += 1
            g = garbled(t)
